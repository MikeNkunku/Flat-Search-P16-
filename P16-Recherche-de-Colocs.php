 ...
 <body style="text-align: center; font-family: Arial">
  ...
  <?php
   $links = array(
    ...
    "comments" => "Pas de télé en vue d'après la description, mais WiFi déjà inclu<br/>
    ...
    "endDate" => "",
    "numberOfRooms" => "\"3\"",
    "furniture" => "Oui : plaques électriques, four, armoire, congélo, micro-ondes",
    "numberOfParkings" => "Non renseigné",
    "comments" => "2 vraies chambres, pas très cher ! photos en pièce joointe   <br/>
	Electricité non incluse dans le loyer indiqué<br/>
	Gare, commerces et activités à proximité"
    ...
    "numberOfParkings" => "\"Place parking privée\"",
    ...
    "comments" => "Pas d'info sur les transports vers Sophia.<br/>
    ...
    "numberOfParkings" => "Non renseigné",
    "comments" => "Pas chaud à cause du cas 2 lits simples pour l'une des chambres : du coup, je pense
    ...
    "comments" => "Celui-ci me convient aussi, mais je veux voir la gueule de l'autre chambre O:-)
	<br/>Le plus important ... IL Y A UNE TV SI ON VEUT SE FAIRE UNE COLOC' SUPER COOL AVEC DES
	SOIREES CALL OF ! =D
    <br/>les deux chambres font 9m2 avec 1 lit 140x190 et un armoire penderie."
   ), array(
    ...
    "comments" => "La photo de la terrasse n'est pas ouf, mais le salon, avec sa luminosité, donne
	plutôt envie.<br/>
    ...
    "numberOfParkings" => "\"Parking privé\"",
    "comments" => "Aucune info sur la connexion internet et sur les transports à proximité."
   ), array(
    ...
    "numberOfParkings" => "Non renseigné",
    "comments" => "Aucune info sur la connexion internet.<br/>
    ...
    "numberOfParkings" => "\"Parking privé\"",
    "comments" => "Le fait que la superficie ne soit pas indiquée rend l'annonce super louche ...<br/>
    ...
    "numberOfParkings" => "\"Parking privé\"",
    "comments" => "Franchement, il a l'air top ! Espérons qu'il soit encore dispo ^^"
   ), array(
    ...
    "numberOfParkings" => "Non renseigné",
    "comments" => "La qualité des photos n'est pas ouf, mais la description est pas mal je trouve.<br/>
	Il y a une télé, mais pas d'info à propos d'une connexion internet ...<br/>
	L'annonce dit qu'il y actuellement un colocataire, donc à confirmer pour la disponibilité des deux chambres :)"
   ), array(
    ...
    "comments" => "Il faudrait une photo des chambres.<br/>
